...
class OrderCrudController extends AbstractCrudController
{
    ...
    {
        $updatePreparation = Action::new('updatePreparation', 'Préparation en cour', 'fas fa-box-open')->linkToCrudAction('updatePreparation');
    ...
    // pour mettre que la <command> est en prep
    ...
    // pour trier les commandes dans esay admin
    ...
    {
        return [
                                // c'est pour afficher l'index que dans l'order, on peut modifier la commande
            IdField::new('id')->onlyOnIndex(),
            DatetimeField::new('createdAt', 'Date de commande'),
            TextField::new('user.getfullName', 'User'),
            TextEditorField::new('delivery', 'Addresse de livraison')->onlyOnDetail(),
